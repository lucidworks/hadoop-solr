...
6. Develop on `new_branch` branch `only`, `do not merge _new_branch_ branch to your master`
7. Commit changes to `new_branch` branch:
...
9. Repeat steps 6-8 until development is complete
10. Fetch upstream changes that were done by other contributors:
...
12. Merge master branch into `new_branch` branch
...
13. If conflicts would happen, use this tutorial to fix them: https://help.github.com/articles/resolving-a-merge-conflict-from-the-command-line/[https://help.github.com/articles/resolving-a-merge-conflict-from-the-command-line/]
14. Push master changes to `new_branch` branch
